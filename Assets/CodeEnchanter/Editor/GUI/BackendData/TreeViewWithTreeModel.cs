...
namespace MerryYellow.CodeEnchanter.UnityEnchanterGUI
{
    ...
    public delegate void TreeModelChangedDelegate();
    public delegate void TreeItemListArgDelegate(IList<TreeViewItem> items);
    ...
    internal class TreeViewWithTreeModel<T> : TreeView where T : TreeElement
	{
		...
		public event TreeModelChangedDelegate treeChanged;

		public TreeModel<T> treeModel { get { return m_TreeModel; } }
		public event TreeItemListArgDelegate beforeDroppingDraggedItems;
