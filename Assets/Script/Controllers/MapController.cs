...
public class MapController : MonoBehaviour {
	...
	void Update()
	{
		...
		if (Application.isEditor || 
		    GetDeviceModel.currentDeviceModel == "Playstation Vita TV") 
		{
		...
		if (GetDeviceModel.currentDeviceModel == "Playstation Vita")
		{
			    ...
			    Input.GetTouch(1).phase == TouchPhase.Moved)
			{
				...
				//previous distance using delta positions					
				...
				//+- value for pinch/spread of touches
