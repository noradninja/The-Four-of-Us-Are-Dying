...
#pragma warning disable
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (isFeasibleTargetForPolyFew)
            {
                ...
                if(isPlainSkin)
                {
                    if (GUILayout.Button("<size=14><b>POLY FEW</b></size> <size=7><b>v7.30</b></size>", style)) { toolMainFoldout = !toolMainFoldout; }
                }
                else
                {
                    if (GUILayout.Button("<size=14><color=#A52A2AFF><b>POLY FEW</b></color></size> <size=7><b><color=#A52A2AFF>v7.30</color></b></size>", style)) { toolMainFoldout = !toolMainFoldout; }
                }
                                        ...
                                        if (originalRendererPair.attachedToMeshFilter)
                                        {
                                            ...
                                            if (filter != null)
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    //Overwrites the mesh assets and keeps references intact
                                                    if (OverwriteAssetAtPath(originalRendererPair.mesh, moddedMesh)) {  }
                                                    else
                                                    {
...
#pragma warning disable
                    ...
                    if (FoldoutAutoLOD)
                    {
                        ...
                        if (GUILayout.Button(content, style, GUILayout.Width(134), GUILayout.Height(17), GUILayout.ExpandWidth(false)))
                        {
                            ...
                            if (lastRect != null)
                            {
                                ...
                                PopupWindow.Show(lastRect, new PopupToggleTemplate(definitions, new Vector2(230, 102), null, null));
                            }
        ...
        public void DrawBatchFewUI(bool boxDrawnAlready = false)
        {
            ...
            content = new GUIContent();
            if (isPlainSkin) { content.text = "<size=13><b>BATCH FEW</b></size> <size=7><b>v2.5</b></size>"; }
            else { content.text = "<size=13><b><color=#A52A2AFF>BATCH FEW</color></b></size> <size=7><b><color=#A52A2AFF>v2.5</color></b></size>"; }
            ...
            if (FoldoutBatchFew)
            {
                ...
                if (didPressButton)
                {
                    ...
                    try
                    {
                        ...
                        bool success = MaterialCombiner.CombineMaterials(Selection.gameObjects, BatchFewSavePath, dataContainer.textureArraysSettings, colorSpace, ConsiderChildrenBatchFew, true, (string error) =>
                        {
                ...
                if (GUILayout.Button(content, style, GUILayout.Width(134), GUILayout.Height(17), GUILayout.ExpandWidth(false)))
                {
                    ...
                    if (lastRect != null)
                    {
                        ...
                        definitions[0] = new PopupToggleTemplate.ToggleDefinition(content, 116, -4, (bool value) =>
                        {
                        ...
                        definitions[1] = new PopupToggleTemplate.ToggleDefinition(content, 116, -4, (bool value) =>
                        {
                        ...
                        definitions[2] = new PopupToggleTemplate.ToggleDefinition(content, 116, -4, (bool value) =>
                        {
                        ...
                        PopupWindow.Show(lastRect, new PopupToggleTemplate(definitions, new Vector2(160, 78), null, null));        
                    }
