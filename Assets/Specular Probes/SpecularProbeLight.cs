...
public class SpecularProbeLight : MonoBehaviour
{
#if UNITY_EDITOR
    [Tooltip(
        "The intensity of the Light will be multiplied by this. Recommended to raise for small lights, and lower for large lights")]
    ...
    public void Draw()
    {
        ...
        instance.meshFilter.sharedMesh = ((GameObject)Resources.Load("SpecSphere", typeof(GameObject)))
...
// #endif
        ...
        {
            lightSphereMaterial.color = new Color(light.color.r * CalcBrightness(),
                light.color.g * CalcBrightness(),
                light.color.b * CalcBrightness(), 1);
        }
        //}
