...
#include "UnityStandardConfig.cginc"
    ...
    VertexOutputForwardAddSimple_VC vertAdd (VertexInput_VC v) { return vertForwardAddSimple(v); }
    half4 fragBase (VertexOutputBaseSimple i) : SV_Target { return fragForwardBaseSimpleInternal(i); }
    half4 fragAdd (VertexOutputForwardAddSimple_VC i) : SV_Target { return fragForwardAddSimpleInternal(i); }
#else
