...
half SpecularStrength(half3 specular)
{
        ...
        return  max (max (specular.r, specular.g), specular.b); // Red channel - because most metals are either monocrhome or with redish/yellowish tint
    #else
...
//  *) precision - half instead of half
...
half3 ShadeSHPerPixel (half3 normal, half3 ambient, half3 worldPos)
{
...
//-------------------------------------------------------------------------------------
inline half3 BoxProjectedCubemapDirection (half3 worldRefl, half3 worldPos, half4 cubemapCenter, half4 boxMin, half4 boxMax)
{
