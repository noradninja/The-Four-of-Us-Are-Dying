...
Shader "Vita/Standard Mobile Lerp"
{
    Properties
    {
        _Color("Color", Color) = (1,1,1,1)
        _MainTex("Albedo", 2D) = "white" {}
        _PainTex("Damage Albedo", 2D) = "white" {}
        _Cutoff("Alpha Cutoff", Range(0.0, 1.0)) = 0.5
        _PainValue ("Crossfade Damage", Range (0.0, 1)) = 0.0
        ...
        _Bump2Scale("Scale", Float) = 1.0
        _BumpMap2("Normal Map B", 2D) = "bump" {}
        _CrossFade ("Crossfade Normal", Range (0.0, 1)) = 0.0
