...
{
    internal class Standard_VCShaderGUI_Lerp : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent albedoTextB = new GUIContent("Damage", "Albedo (RGB)");
        ...
        MaterialProperty damageXFade = null;
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            albedoMapB = FindProperty("_PainTex", props);
            damageXFade = FindProperty("_PainValue", props);
            ...
            bumpMapB = FindProperty("_BumpMap2", props);
            bumpXFade = FindProperty("_CrossFade", props);
        ...
        void DoNormalArea()
        {
            ...
            m_MaterialEditor.TexturePropertySingleLine(Styles.normalMapBText, bumpMapB);
            m_MaterialEditor.ShaderProperty(bumpXFade, Styles.bumpX.text, MaterialEditor.kMiniTextureFieldLabelIndentLevel + 1);
        ...
        void DoAlbedoArea(Material material)
        {
            ...
            m_MaterialEditor.TexturePropertySingleLine(Styles.albedoTextB, albedoMapB);
            m_MaterialEditor.ShaderProperty(damageXFade, Styles.dammageX.text, MaterialEditor.kMiniTextureFieldLabelIndentLevel + 1);
