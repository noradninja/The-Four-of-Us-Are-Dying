...
IL_007a:
	...
	}
	{
		...
		NullCheck(L_31);
		TypeU5BU5D_t3940880105* L_32 = VirtFuncInvoker0< TypeU5BU5D_t3940880105* >::Invoke(94 /* System.Type[] System.Type::GetGenericArguments() */, L_31);
...
IL_0073:
	{
		...
		NullCheck(L_11);
		Type_t * L_13 = VirtFuncInvoker1< Type_t *, TypeU5BU5D_t3940880105* >::Invoke(90 /* System.Type System.Type::MakeGenericType(System.Type[]) */, L_11, L_12);
...
IL_00ce:
	{
		...
		NullCheck(L_26);
		TypeU5BU5D_t3940880105* L_27 = VirtFuncInvoker0< TypeU5BU5D_t3940880105* >::Invoke(94 /* System.Type[] System.Type::GetGenericArguments() */, L_26);
...
IL_0181:
	{
		...
		NullCheck(L_49);
		Module_t2987026101 * L_51 = VirtFuncInvoker1< Module_t2987026101 *, String_t* >::Invoke(19 /* System.Reflection.Module System.Reflection.Assembly::GetModule(System.String) */, L_49, L_50);
		V_2 = L_51;
